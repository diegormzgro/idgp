  ...
  return (
    <div>
      <div
        ...
        class="d-block d-sm-none carousel slide"
            ...
            <div className="container">
              <div className="carousel-caption text-start">
                <h2 className="display-3 fw-bold">
                  Ciclo de cursos temáticos sobre la gestión pública municipal{" "}
                </h2>
            ...
            <div className="container">
              <div className="carousel-caption text-start">
                <h2 className="display-3">
                  Congreso internacional de gestion publica{" "}
                </h2>
      ...
      <div
        id="carouselExampleIndicators"
        class="d-none d-sm-block carousel slide"
        data-bs-ride="carousel"
      >
        <div class="carousel-inner">
          <div class="carousel-item active">
